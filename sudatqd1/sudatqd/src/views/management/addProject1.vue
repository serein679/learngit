<template>
    <div> <!--添加专业对话框-->
      ...
      <el-tabs class="el-tab-div" style="font-family: STKaiti;font-size: 26px;">
        <el-form :model="addPaper" ref="addPaper" style="font-size: 32px !important" :rules="rules">
          ...
          <el-form-item label="纸张图片" :label-width="formLabelWidth" style="width: 630px;">
            <!-- <el-input v-model="fileName" :readonly='true' placeholder="文件名" style="width:388px;" clearable>
            </el-input> -->
            <el-upload class="upload-demo" ref="upload" action="doUpload" :limit="3" :file-list="fileList"
            style="float:right" :before-upload="beforeFileUpload" :on-change="changeCarPicture" :on-success="(res, file, files) => { return handleSuccessLogo1(res, file, files, 1); }">
            ...
            style="float:right" :before-upload="beforeFileUpload" :on-change="changeCarPicture">
              <el-button slot="trigger" type="primary">上传文件<i class="el-icon-upload el-icon--right"></i></el-button>
              <div slot="tip" class="el-upload__tip">只能上传1M以内的文件</div>
            </el-upload> -->

    ...
    <div style="margin-top: 8px;background-color: antiquewhite;">
        <div>
            ...
            <div style="text-alicenter">
                <el-upload class="upload-demo" ref="upload" action="doUpload" :limit="1" :file-list="fileList" id="id"
                    :http-request="modeUpload" :auto-upload="true" :before-upload="beforeFileUpload" :headers="headers">
...
export default {
    ...
    methods: {
        ...
        uploadOcr() {
            ...
            uploadOcr(this.file).then(response => {

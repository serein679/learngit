      ...
      <div>
        <el-row>
          ...
          <el-col :span="10" style="margin-top: 43px;">
            <el-breadcrumb separator="/">
              ...
              <el-breadcrumb-item :to="{ path: '/introduction' }"> 机构库 </el-breadcrumb-item>
              <el-breadcrumb-item><a href="/">机构详情</a></el-breadcrumb-item>
            </el-breadcrumb>
          </el-col>
        </el-row><!--导航-->
        ...
        <el-row style="height: auto;">
          <el-col :span="14" style="position: relative;font-family: STKaiti;font-size: 22px;text-align: left;top: 0%;width: 60%;height: auto;margin-left: 10%;margin-left: 5%;background-color: white;margin-top: 5%; margin-bottom: 5%;border-radius: 30px;">
            <div>
              <table :data=oneIn.institutionItem style="margin-left:5%;width: 100% ;line-height: 250%;">
                <tr>
                ...
                <tr>
                  <div 
                    style="width: 90%;margin-left: 5;margin-right: 5%;text-indent: 2em;line-height: 200%;text-align: justify;">
                    {{ oneIn.institutionItem.institutionDescription }}
                  </div>
                </tr>
                <tr>
                  <font style="font-weight: bold;">机构地址：</font> {{ oneIn.institutionItem.institutionLocation }}
                </tr>
                <tr>
                  <font style="font-weight: bold;"> 机构始建日期：</font>
                  {{ new Date(oneIn.institutionItem.institutionDate).toLocaleDateString('zh').replaceAll('/', '-') }}
                </tr>
                <tr>
                  <div
                    style="margin-left: 0px;float: left; font-weight: bold;margin-top: 10px;height:auto;font-weight: bold; ">
                    珍藏的档案：
                  </div>
                  <!-- <br> -->
                  <div v-for="item in archiveList" v-if="item.institutionId == oneIn.institutionItem.institutionId"
                    style="margin-left: 140px;width: 100%; vertical-align: top;float: left;margin-top: 10px;">
                    <font
          ...
          <el-col :span="6" style="float: right;margin-top: 5%;margin-right: 5%; ">
            <div>
              <table :data=oneIn style="margin-left:1%;width: 100% ;">
                <tr>
                  <div class="biao">
                    {{ oneIn.institutionItem.institutionName }}
                  </div>
                </tr>
              </table>
            </div>
            <div>
              <table v-for="r in oneIn.pictureList" style="margin-left:15%;">
                <tr>
                  <img :src="r.pictureLocation" width="340px" height="250px"  style="margin-top: 15%;">
                </tr>
              </table>
            </div>
          </el-col>
        ...
        <el-row style="height: auto;">
          <el-col :span="20" style="">
            <table
              ...
              <el-empty description="暂无评论" v-if="oneIn.commentList.length < 1"></el-empty>
              <table :data="oneIn.commentList"
                style="margin-left:0%;width: 100% ; margin-left: 5%;margin-top:  2%;border-collapse: collapse;">
                <tr v-for="(t, i) in oneIn.commentList" :key="i" 
          ...
          <!-- 顶级留言：这没什么好说的，就直接展示遍历的结果 -->
            <div class="listbox-top-user" style="font-family: STKaiti;font-size: 22px;color: rgba(0, 0, 0, 0.671); margin: 3%;margin-top: 2%;line-height: 110%;">
              ...
              <span style="margin-left: 77%;margin-top: 5%;margin-bottom: 2%">发布时间：{{ new Date(item.replyTime).toLocaleString('zh').replaceAll('/', '-') }}</span>
...
import {   getOneIn} from '@/api/institution'
  ...
  methods: {
    ...
    getOneIn(institutionId) {
      getOneIn(institutionId).then((response) => {
        this.oneIn = response.data;
        console.log(this.oneIn);
      });
    },
    addreply1() {
      // 打印 addresource 对象

            ...
            <div>
                <el-row>
                    ...
                    <el-col :span="10" style="margin-top: 43px;">
                        <el-breadcrumb separator="/">
                            ...
                            <el-breadcrumb-item :to="{ path: '/introduction/echarts' }"> 纤维库 </el-breadcrumb-item>
                            <el-breadcrumb-item><a href="/">纤维详情</a></el-breadcrumb-item>
                        </el-breadcrumb>
                    </el-col>
                </el-row><!--导航-->
                <el-row style="height: auto;">
                    <el-col :span="18"
                        ...
                        <div>
                            <table :data="oneMa.fiberItem " style="margin-left:3%;width: 100% ;line-height: 290%;">
                                <tr>
                                ...
                                <tr>
                                    <div 
                                        ...
                                        {{ oneMa.fiberItem.fiberType }}
                                    </div>
                                </tr>
                                <tr style="margin-left: 40px;">
                                    <div style="margin-left: 40px;">
                                        纤维原料特点： {{ oneMa.fiberItem.characteristic }}
                                    </div>
                                </tr>
                                <tr style="margin-left: 40px;">
                                    ...
                                    <div v-for="item in oneMa.paperFiberList" 
                                        style="margin-left: 40px;width: 20%; vertical-align: top;float: left;">
                                        <font
                                            style="cursor: pointer;font-family: STKaiti;font-weight:200;color: rgb(205, 134, 63);display:inline-block;vertical-align: top; "
                                            @click="select(item.paperId)">
                                            {{
                                                item.paperName }}</font>
                                    </div>
                                </tr>
...
import { getOneFi, getFibers } from '@/api/fiber'
